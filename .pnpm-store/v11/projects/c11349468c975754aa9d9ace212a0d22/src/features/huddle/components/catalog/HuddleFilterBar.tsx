 ...
 */
export function HuddleFilterBar({ filters, options, roles, audienceRoleIds, onAudienceChange, onFilterChange }: HuddleFilterBarProps) {
  return (
    <div className="grid grid-cols-1 items-end gap-3 md:grid-cols-2 lg:grid-cols-5">
      <HuddleAudienceSelect mode="multi" roles={roles} selectedIds={audienceRoleIds} onChange={onAudienceChange} />
