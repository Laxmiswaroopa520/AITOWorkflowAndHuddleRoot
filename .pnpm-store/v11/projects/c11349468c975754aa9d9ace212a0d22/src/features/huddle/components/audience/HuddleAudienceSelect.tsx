...
import { Briefcase, Building2, Check, ChevronDown, Cpu, Handshake, Plus, Shield, Target, Users2, Wrench } from "lucide-react";
...
export function HuddleAudienceSelect({ roles, mode = "single", selectedIds, onChange }: HuddleAudienceSelectProps) {
      ...
      {open && (
        <div role="listbox" aria-multiselectable={multi} className="absolute left-0 z-30 mt-1 w-80 overflow-hidden rounded-xl border bg-white shadow-xl">
          ...
          <div className="max-h-80 overflow-y-auto p-2">
            {segments.length === 0 && <p className="px-2 py-6 text-center text-sm text-muted-foreground">No audience roles available.</p>}
