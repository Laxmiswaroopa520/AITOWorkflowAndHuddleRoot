...
public static class AuthenticationExtensions
{
        ...
        IConfiguration configuration)
    {
        ...
        // Inbound authentication is handled by Microsoft.Identity.Web, which validates the
        // bearer token against the tenant/client configured in the "AzureAd" section above.
        // EnableTokenAcquisitionToCallDownstreamApi() + AddInMemoryTokenCaches() register the
        // outbound delegated Microsoft Graph token acquisition (ITokenAcquisition) that
        // GraphWorkflowCalendarService, GraphHuddleLaunchMailService, and
        // GraphCoachSchedulingService resolve and call GetAccessTokenForUserAsync(...) on,
        // exactly as before.
        services
            .AddAuthentication(
