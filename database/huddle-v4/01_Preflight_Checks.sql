...
-- Duplicate role abbreviations break the joins in scripts 02 and 03.
INSERT INTO @missing ([Object], [Detail])
SELECT N'dbo.Roles.' + r.Abbreviation,
       N'Abbreviation appears ' + CAST(COUNT(*) AS NVARCHAR(10)) + N' times. Run huddle-v4-reset/00_REPAIR_Remove_Duplicate_Roles.sql.'
