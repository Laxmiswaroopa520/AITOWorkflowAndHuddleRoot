/* =============================================================================================
   ...
   This script has no USE statement, and this folder assumes no fixed database name anywhere.
   Select your own target database in SSMS before running this script (and every script after
   it) -- whatever you called it. The Workflow scripts (10 to 15) used to hardcode a USE
   statement pointing at one specific database name; that line has been removed from this folder.
   ============================================================================================= */
