...
(N'WF-WORKLOAD-01',N'Prioritize AI and Azure Workloads by Readiness and Impact',NULL,N'Prescriptive',N'WorkingDraft',N'focus-solution-strategy',30,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL); SELECT @SourceCount=COUNT(*) FROM @Source;
