...
(N'required-researcher',N'Researcher',N'Investigate complex topics and prepare credible, decision-ready briefs.',N'Foundation',N'WorkingDraft',NULL,15,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
(N'required-sales-agent',N'Sales Agent',N'Execute seller workflows using grounded sales and customer data.',N'Foundation',N'WorkingDraft',NULL,20,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
(N'required-cowork',N'Cowork',N'Delegate a multi-step Microsoft 365 outcome rather than completing each step manually.',N'Foundation',N'WorkingDraft',NULL,15,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
(N'required-scout',N'Scout',N'Coordinate work that spans local files, browsers, systems, and Microsoft 365.',N'Foundation',N'WorkingDraft',NULL,20,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
(N'required-agent-j',N'Agent J.ai',N'Prepare for, practise, and improve important customer and stakeholder conversations.',N'Foundation',N'WorkingDraft',NULL,15,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL); SELECT @SourceCount=COUNT(*) FROM @Source; SELECT @DuplicateCount=COUNT(*) FROM(SELECT ExternalId FROM @Source GROUP BY ExternalId HAVING COUNT(*)>1)d; IF @DuplicateCount>0 THROW 51001,'Duplicate topic external IDs.',1;
