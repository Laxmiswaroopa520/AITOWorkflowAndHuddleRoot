...
(N'ce-ent',N'Commercial Executive',N'CE',N'Enterprise',N'Structures pricing, licensing, and commercial terms for deals and coordinates across team.',5,CAST(1 AS bit)),
(N'ats-ent',N'Account Technology Strategist',N'ATS',N'Enterprise',N'Owns the technical strategy and solution roadmap for enterprise accounts.',2,CAST(1 AS bit)),
(N'ssp-ent',N'Solution Sales Professional',N'SSP',N'Enterprise',N'Drives solution-specific opportunities by shaping vision and leading value-based conversations.',3,CAST(1 AS bit)),
(N'se-ent',N'Solution Engineer',N'SE',N'Enterprise',N'Leads technical discovery, qualification, and execution of demos, PoCs, and solution designs.',4,CAST(1 AS bit)),
(N'csa-ces',N'Cloud Solution Architect',N'CSA',N'Enterprise',N'Designs and validates cloud and AI architectures for customer success.',6,CAST(1 AS bit)),
(N'csam-ces',N'Customer Success Account Manager',N'CSAM',N'Enterprise',N'Drives customer adoption, expansion, and renewal through success planning.',7,CAST(1 AS bit)),
