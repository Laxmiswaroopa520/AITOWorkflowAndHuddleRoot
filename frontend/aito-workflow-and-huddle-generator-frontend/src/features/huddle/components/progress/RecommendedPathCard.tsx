      ...
      >
        ...
        <span className="mt-2 flex flex-wrap items-center gap-x-4 gap-y-1 text-xs text-muted-foreground">
          ...
          <span className="flex items-center gap-1">
            ...
            {card.featuredActivityCount !== null && card.extendedActivityCount !== null && card.extendedActivityCount > 0
              && <span className="text-[#707070]"> ({card.featuredActivityCount} featured, {card.extendedActivityCount} extended)</span>}
          </span>
          {card.mcemStageLabel && (
            <span className="flex items-center gap-1">
