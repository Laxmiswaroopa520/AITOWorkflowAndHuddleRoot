...
const whyItExists: Array<[string, string, ElementType]> = [
...
const successSignals: Array<[string, string, ElementType]> = [
...
const journeySteps: Array<[string, string, string, string, string, ElementType, string]> = [
  ...
  ['03', 'All Topics', 'Explore more workflows and build a custom plan around what matters next.', 'Flexible', 'Extend fluency beyond the core path.', BookOpen, '#F0E9E3'],
];
